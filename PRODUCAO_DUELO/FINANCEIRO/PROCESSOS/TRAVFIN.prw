...
ฑฑบDescricao ณINFORMA DATA PARA TRAVAR O FINANCEIRO 22/08/16              บฑฑ
...
User Function TRAVFIN()

Private oEst                                                    
Private cFimLin := (chr(13)+chr(10))
Private dDTEST  := getmv("MV_DATAFIN")
Private oDTEST
Private cMsg1 := "Aten็ใo, nใo serแ possํvel efetuar"
pRIVATE cMsg2 := "baixas anteriores a data"
...
@ 005,005 Say OemToAnsi("Financeiro: ") PIXEL COLORS CLR_HBLUE OF oEst 
...
if lPar
     if MsgYESNO("Confirma atualiza็ใo de data de fechamento?","Atencao...","YESNO")
          putmv("MV_DATAFIN",dParEst)
          
     MsgInfo("Fechamento Financeiro: "+dtoc(dParEst)+chr(13)+chr(10))
