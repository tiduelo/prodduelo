...
//************************
User Function WFCobLug()
//************************
Local nRadMenu1 := 1
Local aArea := GetArea()
Local _cQry  := ""  

Conout("Empresa: 05 Filial: 01")
...
Do While !TMPSE1->(Eof())
	...
	U_ECobLug(TMPSE1->CLIENTE, TMPSE1->LOJA)   // chamada da funcao - INCLUIDO -Claudio Oliveira - 29042014.	
...
//************************
User Function ECobLug(_cSE1Cli, _cSE1Loj)
//************************               
...
Do While !TMPWF->(Eof())
	...
	cHtmlModelo := "\Workflow\WF_HTML\ADM\WfCobLugPet.html"
