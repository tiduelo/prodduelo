...
IF SC5->C5_TIPOCLI == "S" .and. _cEst $ "PA/AP"       //Testa se o cliente � do estado do Para ou Amapa
	...
	ElseIf  _cSb1Grup $ '0203|0205'   // Suco Tampico E CH�
	...
	If _lSuframa
		...
		_nBaseRet -= 0 // _nCrePre  - alterado em 14/07/2015 a pedido da Controladoria para nao abater o ICMS descontado da base da Subst. Tribut�ria
