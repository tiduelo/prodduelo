...
For nZ := 1 To nLenDet
	...
	*/
	...
	Else
	    nVTotal  := Val(oDet[nX]:_Prod:_vProd:TEXT)//-Val(IIF(Type("oDet[nPrivate]:_Prod:_vDesc")=="U","",oDet[nX]:_Prod:_vDesc:TEXT))
//	    nVUnit   := IIF(MV_PAR07 == 2, Val(oDet[nX]:_Prod:_vUnCom:TEXT),Val(oDet[nX]:_Prod:_vUnTrib:TEXT)) // RAFAEL ALMEIDA - SIGACORP VALIDAÇÃO IMPRESSAO VALOR CONTRIBUTARIO 
...
//	nQtd     := IIF(MV_PAR07 == 2 , Val(oDet[nX]:_Prod:_qCom:TEXT),Val(oDet[nX]:_Prod:_qTrib:TEXT)) // RAFAEL ALMEIDA - SIGACORP VALIDAÇÃO IMPRESSAO VALOR CONTRIBUTARIO 
...
//		IIF(MV_PAR07 == 2,oDet[nX]:_Prod:_uCom:TEXT,oDet[nX]:_Prod:_utrib:TEXT),;     //RONALDO
	aadd(aItens,{;
		...
		IIF(MV_PAR09 == 2,oDet[nX]:_Prod:_uCom:TEXT,oDet[nX]:_Prod:_utrib:TEXT),;     //RONALDO		
